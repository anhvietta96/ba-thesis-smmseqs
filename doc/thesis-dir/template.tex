...
\begin{align}
\text{Env}_k(u) = \{(v_{0}v_{1}\ldots v_{q-1},s) \mid & ~((v_{0},s_{0}),(v_{1},s_{1}),\ldots (v_{q-1},s_{q-1}))\in\bigtimes_{i=0}^{q-1}\Scoretable{1}{\Subchar{u}{i}},\nonumber\\
...
\begin{itemize}
\item the output is an array of length 
