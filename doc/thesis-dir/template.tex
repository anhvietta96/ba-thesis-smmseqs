...
integer encoding, where the characters are assigned a weight, which is expressed
...
stays relatively close to expected. This shows that both methods are seemingly
not stable in higher seed weights. This issue shoul be investigated further.
